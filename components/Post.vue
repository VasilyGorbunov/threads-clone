      ...
      <div class="flex items-center">
        <div class="flex items-center flex-wrap text-white gap-1 w-[42px]">
          <div class="flex gap-0.5">
            <img class="rounded-full h-[14px] mt-2" src="https://loremflickr.com/100/100?random=1"/>
            <img class="rounded-full h-[17px]" src="https://loremflickr.com/100/100?random=2"/>
          </div>
          <div class="flex items-center">
            <img class="rounded-full h-[11px] ml-4" src="https://loremflickr.com//100/100?random=3">
          </div>
        </div>
      </div>
    </div>
